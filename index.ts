...
const exerciseOne = () => {
    ...
    // If the type is not explicitly specified, TypeScript will infer the type of the variable from the initialized value, but it wasn't able to do that, so the initial value was passed
